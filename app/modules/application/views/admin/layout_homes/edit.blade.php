...
@section('content')
    ...
    {{ Form::model($build, array('route'=>array('layouts_homes.update', $build->id),'class'=>'smart-form','id'=>'buildings-form','role'=>'form','method'=>'put')) }}
    {{ Form::hidden('number') }}
    {{ Form::hidden('sold') }}
    ...
    <div class="row">
        <section class="col col-6">
            <div class="well">
                <header>Редактирование макета дома:</header>
                <fieldset>
                    <section>
