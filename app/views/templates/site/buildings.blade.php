    ...
    <div class="us-page">
        <div class="wrapper">
            ...
            <div class="us-desc">
                ...
                типовые проекты наших партнеров. <span class="info-tooltip" data-tooltip="Типовые проекты это наиболее популярные варианты домов. Это не означает что вы ограничены только ими – вы можете вносить свои корректировки или заказать индивидуальный проект."></span>
            </div>
